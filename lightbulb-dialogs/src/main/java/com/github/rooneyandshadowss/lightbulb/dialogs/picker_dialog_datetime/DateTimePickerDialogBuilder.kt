package com.github.rooneyandshadowss.lightbulb.dialogs.picker_dialog_datetime
...
class DateTimePickerDialogBuilder @JvmOverloads constructor(
    ...
    dialogTag: String,
) : com.github.rooneyandshadowss.lightbulb.dialogs.base.BaseDialogBuilder<DateTimePickerDialog>(lifecycleOwner, manager, dialogTag) {
