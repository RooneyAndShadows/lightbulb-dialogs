package com.github.rooneyandshadowss.lightbulb.dialogs.dialog_alert
...
class AlertDialogBuilder @JvmOverloads constructor(
    ...
    dialogTag: String
) : com.github.rooneyandshadowss.lightbulb.dialogs.base.BaseDialogBuilder<AlertDialog>(lifecycleOwner, dialogParentFragmentManager, dialogTag) {
