...
public abstract class LightBulbPickerDialogFragment<SelectionType> extends LightBulbDialogFragment {
    protected final LightBulbDialogSelection<SelectionType> selection;
    ...
    protected LightBulbPickerDialogFragment(LightBulbDialogSelection<SelectionType> selection) {
        this(selection, true);
    }

    public LightBulbPickerDialogFragment(LightBulbDialogSelection<SelectionType> selection, boolean synchronizeUiOnDraftChange) {
        ...
        selection.addSelectionListeners(new LightBulbDialogSelection.PickerSelectionListeners<SelectionType>() {
            @Override
